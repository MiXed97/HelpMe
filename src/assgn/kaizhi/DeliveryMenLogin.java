 ...
 * @author KaiZhi
 */
public class DeliveryMenLogin extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DeliveryMenLogin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
